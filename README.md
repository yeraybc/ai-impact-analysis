...
6. **Interpretación de coeficientes** mediante odds ratios para traducir los resultados del modelo.
...
Diferencia train-test negativa en las tres métricas: sin evidencias de sobreajuste.
...
- Base de datos sintético: las conclusiones cuantitativas no deben extrapolarse a poblaciones reales sin validación extra.
